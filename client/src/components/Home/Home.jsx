                        ...
                        return (
                            <>
                                <div className='box-text ' style={{ "--i": a1[j], "--j": a2[j], "--k": a3[j] }}>
                                    ...
                                    <AiTwotonePlusSquare className={`${(arr[j] === p1) ? "transitionp" : "hidden"} ml-[5px] relative top-0 mt-0 pt-0 text-red-500 text-xl border-solid border-black border-spacing-0 border bg-red-600`} />
